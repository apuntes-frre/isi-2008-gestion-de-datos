...
**Para cursar — cursadas:** Análisis de Sistemas, Sintaxis y Semántica de los Lenguajes, Paradigmas de Programación
**Para cursar — aprobadas:** Matemática Discreta, Sistemas y Organizaciones, Algoritmos y Estructuras de Datos
**Para rendir — aprobadas:** Análisis de Sistemas, Sintaxis y Semántica de los Lenguajes, Paradigmas de Programación
